/*
 * Ported from FDPClient's clickgui/ModuleSearch.kt. FDPClient matches against spacedName,
 * aliases, category and subCategory too - myau.module.Module exposes none of those, so this
 * matches on name + description only.
 */
...
class ModuleSearch {
    ...
    fun matches(module: Module): Boolean {
        ...
        val searchable = normalize(module.name + " " + (module.description ?: ""))
